...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.row:
      ...
      return format('<table %s class="%s"><tr>%s</tr></table>', attrs, classes.join(' '), inner);
    ...
    case this.components.container:
      ...
      return format('<table %s align="center" class="%s"><tr><td>%s</td></tr></table>', attrs, classes.join(' '), inner);
